<template>
    ...
    <EasyAuthenticatedLayout>
        ...
        <template #headerLink>
            <EasyLink look="button" class="float-right" :link="route('admin.catalog.product.simple.create')">
                Add New
            </EasyLink>
        </template>

        <easy-table :tableHead="tableHead" :tableData="$page.props.products.data">
